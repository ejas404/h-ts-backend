...
import * as studentCtrl from '../controllers/student/student_auth_controller'
import * as studentProfCtrl from '../controllers/student/student_profile_controller'
import * as studentCourseCtrl from '../controllers/student/student_course_controller'
import * as videoCtrl from '../controllers/video_controller'
import * as checkoutCtrl from '../controllers/student/student_checkout_controller'
import * as paymentCtrl from '../controllers/student/student_payment_controller'
import * as enrollCtrl from '../controllers/student/student_enrollment_controller'
import * as connectionCtrl from '../controllers/student/student_connection_controller'
import * as oauthCtrl from '../controllers/oauth_controller'
import { isStudentAuthenticated, isStudentBlocked } from '../middlewares/auth_middleware'
