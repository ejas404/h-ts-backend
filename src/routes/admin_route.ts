...
import * as adminCtrl from '../controllers/admin/admin_auth_controller.js'
import * as dashCtrl from '../controllers/admin/admin_dashboard_controller.js'
import * as dashMainCtrl from '../controllers/admin/admin_dashboard_main_cotroller.js'
import * as adminCourseCtrl from '../controllers/admin/admin_course_controller.js'
import * as courseControl from '../controllers/course_controller.js'
