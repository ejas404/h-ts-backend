...
import * as adminCtrl from '../controllers/admin/admin_auth_controller'
import * as dashCtrl from '../controllers/admin/admin_dashboard_controller'
import * as dashMainCtrl from '../controllers/admin/admin_dashboard_main_cotroller'
import * as adminCourseCtrl from '../controllers/admin/admin_course_controller'
import * as courseControl from '../controllers/course_controller'
