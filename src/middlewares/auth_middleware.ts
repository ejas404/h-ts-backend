...
export const  isStudentBlocked = asyncHandler(async (req : any,res,next)=>{
...
export const  isTutorBlocked = asyncHandler(async (req : any,res,next)=>{
...
export const isStudentAuthenticated = asyncHandler(async (req : any, res, next) => {
    let token;
    token = req.headers.authorization;
    if (token) {
        try {
...
export const isTutorAuthenticated = asyncHandler(async (req : any, res, next) => {
    let token;
    token = req.headers.authorization;
    if (token) {
        try {
